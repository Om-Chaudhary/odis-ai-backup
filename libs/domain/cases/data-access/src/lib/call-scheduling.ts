...
export async function scheduleDischargeCall(
  ...
  try {
    ...
    currentStep = "getCaseWithEntities";
    ...
    currentStep = "extractVapiVariables";
    ...
    currentStep = "getOrGenerateCallIntelligence";
    ...
    currentStep = "buildDynamicVariables";
    ...
    currentStep = "getClinicVapiConfig";
    ...
    currentStep = "determineScheduledTime";
    ...
    console.error("[CallScheduling] scheduleDischargeCall FAILED", {
      caseId,
      userId,
      currentStep,
