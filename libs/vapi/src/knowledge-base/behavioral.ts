...
export const behavioralKnowledge: ConditionKnowledgeBase = {
  ...
  assessmentQuestions: [
    ...
    },
    {
      ...
      expectedPositiveResponse: ["yes", "eating well", "normal appetite"],
      concerningResponses: [
        "not eating",
        "refusing food",
    ...
    },
    {
      ...
      expectedPositiveResponse: ["yes", "working on it", "practicing daily"],
      concerningResponses: [
        "haven't had time",
        "too difficult",
        "not sure how",
    ...
    },
    {
      ...
      expectedPositiveResponse: ["sleeping well", "resting", "calm at night"],
      concerningResponses: [
        "pacing all night",
        "can't settle",
