...
export const woundCareKnowledge: ConditionKnowledgeBase = {
  ...
  assessmentQuestions: [
    ...
    },
    {
      ...
      expectedPositiveResponse: ["less drainage", "almost dry", "minimal"],
      concerningResponses: [
        "lots of drainage",
        "drain fell out",
        "same amount",
    ...
    },
    {
      ...
      expectedPositiveResponse: ["eating well", "normal energy", "active"],
      concerningResponses: [
        "not eating",
        "very lethargic",
        "weak",
    ...
    },
    {
      ...
      concerningResponses: ["very warm", "hot", "warmer than other areas"],
