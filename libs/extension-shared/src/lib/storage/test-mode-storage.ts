...
const storage = createStorage<TestModeState>('test-mode-storage-key', defaultTestModeState, {
  ...
  serialization: {
    ...
    deserialize: (text: string | undefined) => {
      ...
      try {
        ...
        logger.warn('[test-mode-storage] Failed to parse storage value, using default', { error });
        return defaultTestModeState;
      }
    },
  },
