 ...
 *
 * Shared JSON schema and types for action card structured output.
 * Used by VAPI (analysisPlan.structuredDataPlan) and AI (generate-action-card).
 *
 * @module shared/types/action-card-output
 */

/**
 * Action card output schema for structured data plans.
 * Applied to VAPI assistants' analysisPlan.structuredDataPlan.schema and
 * to LLM prompts for backfilling action card data from transcripts.
 */
