# Dual-Mode API Architecture Implementation
...
This project implements a dual-mode API architecture that:
...
1. **Read the complete plan:** [PARALLEL_TASKS.md](./PARALLEL_TASKS.md)
2. **Pick a task** from the list above
3. **Read the task-specific guide** in `tasks/` directory
4. **Review referenced files** in the codebase
