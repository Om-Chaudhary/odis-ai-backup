  ...
  >
    <div
      className={cn(
        ...
        isCollapsed && "justify-start gap-1.5 whitespace-nowrap",
      )}
    >
      <span
        className="text-primary flex h-5 w-5 items-center justify-center rounded-full bg-white text-[12px] leading-none font-extrabold"
      ...
      {!isCollapsed && (
        <span className="text-[15px] font-bold tracking-wide text-white shadow-sm drop-shadow-sm">
          ODIS
        </span>
      )}
      <span
        className={cn(
          "rounded-full bg-white/20 px-2 py-0.5 text-[11px] font-bold tracking-wide text-white uppercase",
