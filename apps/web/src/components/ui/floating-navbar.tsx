  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button className="relative rounded-full border border-neutral-200 bg-[#31aba3] px-4 py-2 text-sm font-medium text-white dark:border-white/[0.2]">
          <span>Book Demo</span>
          <span className="absolute inset-x-0 -bottom-px mx-auto h-px w-1/2 bg-gradient-to-r from-transparent via-[#31aba3] to-transparent" />
        </button>
      </motion.div>
    </AnimatePresence>
  );
