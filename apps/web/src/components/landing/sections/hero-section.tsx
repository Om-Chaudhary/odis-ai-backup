...
export function HeroSection() {
  ...
  // Track if animation has started (prevents re-triggering on state flickers)
  ...
  // Lock in animation state once triggered (prevents flash/replay on state changes)
  useEffect(() => {
        ...
        >
          ...
          <div className="relative z-10 flex min-h-[100dvh] flex-col p-0 sm:min-h-[94dvh] md:p-4">
            ...
            <m.nav
              ...
              animate={
                hasAnimated ? { opacity: 1, y: 0 } : { opacity: 0, y: -12 }
              }
          ...
          <m.div
            ...
            className="absolute right-6 bottom-28 z-20 hidden transform-gpu lg:right-12 lg:block xl:right-20"
          >
            <m.div
            ...
            >
              <HeroCallCard shouldAnimate={hasAnimated} />
            </m.div>
          </m.div>
