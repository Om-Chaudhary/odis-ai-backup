...
import { EnhancedButton } from "@odis-ai/shared/ui/enhanced-button";
  ...
  return (
    <>
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-emerald-50 via-emerald-100/40 to-emerald-50/30">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-32 pb-32 sm:px-6">
          <div className="relative space-y-12 text-center">
            ...
            >
              ...
              <span className="font-serif text-xs leading-tight font-medium text-slate-600 sm:text-sm">
                🚀 Advancing to Phase 2 with NEC X ElevX!
              </span>
            </div>
            ...
            >
              Record and automate veterinary documentation automatically. Focus
              on what matters - caring for your patients.
            </p>

            {/* CTA Button with enhanced animation */}
            <div
              className={`flex flex-col items-center justify-center gap-4 pt-4 transition-all duration-1300 ease-out sm:flex-row ${
                isVisible
                  ? "animate-fade-in-up opacity-100"
                  : "translate-y-3 opacity-0"
              }`}
