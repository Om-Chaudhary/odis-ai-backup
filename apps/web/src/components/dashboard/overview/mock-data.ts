...
export const HAPPY_TAILS_STORY: HappyTailsStory = {
  ...
  discharge: {
    ...
    reachRate: {
      ...
      total: 300,
      percentage: 85,
      story: "254 out of 300 patients reached by phone",
    },
    complianceRate: {
      compliant: 235,
      reached: 254,
      percentage: 93,
      story: "93% confirmed they're following medication instructions",
    },
    outcomes: [
      {
    ...
    weeklyTrend: [
      { day: "Mon", critical: 2, voicemail: 8, recheck: 2, clear: 35 },
      { day: "Tue", critical: 1, voicemail: 6, recheck: 3, clear: 42 },
      { day: "Wed", critical: 2, voicemail: 7, recheck: 1, clear: 28 },
      { day: "Thu", critical: 1, voicemail: 5, recheck: 2, clear: 38 },
      { day: "Fri", critical: 1, voicemail: 4, recheck: 2, clear: 24 },
      { day: "Sat", critical: 0, voicemail: 3, recheck: 1, clear: 12 },
      { day: "Sun", critical: 1, voicemail: 5, recheck: 1, clear: 17 },
    ],
  },
