...
export const dentalKnowledge: ConditionKnowledgeBase = {
  ...
  assessmentQuestions: [
    ...
    },
    {
      ...
      expectedPositiveResponse: ["no", "leaving it alone", "not bothered"],
      concerningResponses: [
        "constantly pawing",
        "rubbing face",
        "scratching at mouth",
    ...
    },
    {
      ...
      concerningResponses: ["won't take it", "missing doses", "vomiting it up"],
    ...
    },
    {
      ...
      concerningResponses: ["not drinking", "refusing water", "messy drinking"],
