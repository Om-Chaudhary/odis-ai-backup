      ...
      <div className="relative space-y-4 sm:space-y-6">
        ...
        <form action={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-[#31aba3] to-[#2a9a92] text-white shadow-lg transition-all duration-300 hover:scale-105 hover:from-[#2a9a92] hover:to-[#31aba3] hover:shadow-lg hover:shadow-[#31aba3]/30 disabled:opacity-50 disabled:hover:scale-100"
          >
