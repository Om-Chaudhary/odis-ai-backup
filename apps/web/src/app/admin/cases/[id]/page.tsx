...
export default function CaseDetailPage() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = api.cases.getCase.useQuery({ id }, { enabled: !!id });
  ...
  const patient = caseData.patient as unknown as {
    name?: string;
    species?: string;
    breed?: string;
    owner_name?: string;
  ...
  const soapNotes =
    (caseData.soap_notes as unknown as Array<{
      id: string;
      subjective?: string;
      objective?: string;
      assessment?: string;
  ...
  const dischargeSummaries =
    (caseData.discharge_summaries as unknown as Array<{
      id: string;
      content?: string;
      created_at: string;
    }>) ?? [];
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Modify case status, type, or visibility
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Select value={status} onValueChange={setStatus}>
                <SelectTrigger>
                  <SelectValue
                    placeholder={caseData.status ?? "Select status"}
                  />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Select value={visibility} onValueChange={setVisibility}>
                <SelectTrigger>
                  <SelectValue
                    placeholder={caseData.visibility ?? "Select visibility"}
                  />
                </SelectTrigger>
                <SelectContent>
          ...
          <Button
            onClick={handleSave}
            disabled={
              updateMutation.isPending || (!status && !type && !visibility)
            }
          >
